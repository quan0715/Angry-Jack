...
public class GameTwoController {
    ...
    public int CheckGameOver(SnakeBody snake1, SnakeBody snake2) {
        if(snake1==null||snake2==null)return 0;
    ...
    public void StartGame() {
        ...
        SkillTextRefresh = new GameFlow(new KeyFrame(Duration.millis(10), e -> {
            SkillRefresh();
        }), -1);
        checkScoreTimeline = new GameFlow(new KeyFrame(Duration.millis(10), e -> {
